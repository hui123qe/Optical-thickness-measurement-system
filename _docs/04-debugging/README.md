...
- [OTMS-DBG-003 环境安装：Visual C++ 2013 运行库](environment-installation.md)
  — `resolved / verified`，记录项目迁移至新电脑后缺少 `MSVCP120.dll` 的原因、安装和验证方法。- [OTMS-DBG-004 物理设备 CL-3000 调试](physical-device-cl3000-debugging.md)
 — `investigating / unverified`，记录物理控制器的网络、安装条件、感测头选择、外部端子、软控制、自动置零与测量数据含义。