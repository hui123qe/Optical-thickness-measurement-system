...
// Transparent peak (2heads Thickness)
typedef enum {
...
extern "C"
{
	...
	CL3_IF_API LONG WINAPI CL3IF_JudgeHeadAlign(LONG deviceId, BYTE headNo1, BYTE headNo2, LONG* judgeHeadAlignStatus);
